...
-- Line(s)
keymap.set('n', '<C-S-k>', ':m -2<CR>', { noremap = true, silent = true }) -- Move 1 line up
keymap.set('i', '<C-S-k>', '<ESC>:m -2<CR>i', { noremap = true, silent = true })
keymap.set('n', '<C-S-j>', ':m +1<CR>', { noremap = true, silent = true }) -- Move 1 line down
keymap.set('i', '<C-S-j>', '<ESC>:m +1<CR>i', { noremap = true, silent = true }) -- Move 1 line down
...
-- Text
keymap.set('v', '<leader>vy', '"*y', { noremap = true, silent = true }) -- Copy to primary
keymap.set({'n', 'v'}, '<leader>vp', '"*p', { noremap = true, silent = true }) -- Paste from primary
keymap.set('i', '<C-p', '<ESC>"*p<ESC>i', { noremap = true, silent = true }) -- Paste from primary
keymap.set('n', '<leader>tU', 'viwUea<Esc>')    -- Change word uppercase
keymap.set('i', '<C-u>u', '<Esc>viwUea', { noremap = true, silent = true })    -- Change word to uppercase
keymap.set('n', '<leader>tu', 'viwuea<Esc>')    -- Change word to lowercase
keymap.set('i', '<C-u>l', '<Esc>viwuea', { noremap = true, silent = true })    -- Change word to lowercase
